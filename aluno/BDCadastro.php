...
//paramentros nomeados
	 "(nome, email, cpf, genero, data_nasc, dd1, telefone) ". "VALUES (:nome, :email, :cpf, :genero, :data_nasc, :ddd, :telefone); ");
...
$stmt -> execute();
 header('Location:  InclusaoOK.html');/*chamada e execução dos dados e inclusão no banco */
 exit;
...
// Captura outras exceções genéricas
     ...
     echo "ATENÇÃO, erro na aplicação: " . $erro->getMessage();
}
